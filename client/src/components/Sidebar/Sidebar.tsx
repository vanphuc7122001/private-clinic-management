        ...
        <ul className='space-y-2 font-medium'>
          <li>
            ...
            >
              ...
              <span className='ms-3'>Quản lý danh mục</span>
            </Link>
          </li>
          <li>
            <Link
          ...
          <li>
            ...
            >
              ...
              <span className='ms-3'>Quản lý lịch làm việc</span>
            </Link>
          </li>
          <li>
            <Link
          ...
          <li>
            ...
            >
              ...
              <span className='ms-3'>Quản lý dịch vụ</span>
            </Link>
          </li>
          <li>
            <Link
          ...
          <li>
            ...
            >
              ...
              <span className='ms-3'>Quản lý lịch hẹn</span>
            </Link>
          </li>
          <li>
            <Link
            ...
            >
              ...
              <span className='ms-3'>Quản lý thuốc</span>
            </Link>
          </li>
          <li>
            <button
