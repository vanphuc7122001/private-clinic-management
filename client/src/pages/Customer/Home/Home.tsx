    ...
    <main>
              ...
              <div className='service__list'>
                ...
                <section className='service-item'>
                  ...
                  <div className='service-item__body'>
                    ...
                    <p className='desc service-item__desc line-clamp'>
                      ...
                      khỏe mà còn là hòa nhạc tinh tế của cuộc sống, nơi nhịp đập tạo nên bản giao hưởng riêng biệt của
                      mỗi người.
                    </p>
                  </div>
                </section>
                <section className='service-item'>
                  ...
                  <div className='service-item__body'>
                    ...
                    <p className='desc service-item__desc line-clamp'>
                      Nội soi - bí mật của y học mở ra trước mắt, như một chiếc kính phép thuật, cho phép chúng ta nhìn
                      thấy những khám phá tinh tế, khám phá vẻ đẹp ẩn sau lớp vỏ, và khám phá những bí ẩn của cơ thể.
                    </p>
                  </div>
                </section>
              </div>
      ...
      <section className='work'>
        <div className='container-app'>
          ...
          <p className='desc work__desc'>Chăm sóc đặc biệt mọi độ tuổi . Nụ cười của bạn là niềm vui của chúng tôi.</p>
