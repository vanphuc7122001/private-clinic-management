...
export default function Caterogy() {
  ...
  const deleteCategoryMutation = useMutation({
    ...
    mutationFn: (id: string) => caterogyApi.deleteCaterogy(id),
    onSuccess: (data) => {
      toast.success(data.data.message)
      queryClient.invalidateQueries({ queryKey: ['categories'], exact: true })
    }
                  ...
                  <tr key={element.id} className='bg-white border-b dark:bg-gray-800 dark:border-gray-700'>
                    ...
                    <td className=''>
                      ...
                      <button
                        ...
                        className='focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-1 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900'
                      >
                        Xóa
                      </button>
                    </td>
